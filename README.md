# ES Icons Customizer
Easily change the color or even the icons themselves using this script.

## Change Colors (Easy)
Inside the script change the HEX value of the corresponding variable to change the colors for that icon.
